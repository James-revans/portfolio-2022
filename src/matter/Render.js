...
const { claim_text } = require('svelte/internal');
        ...
        for (i = 0; i < bodies.length; i++) {
            ...
            for (k = body.parts.length > 1 ? 1 : 0; k < body.parts.length; k++) {
                ...
                if(part.render.text) {
                    ...
                    if(part.render.text.circleRadius)
                        circleRadius = part.render.text.circleRadius;
                    var content = "";
                    ...
                    // need some sort of global state to determine if first pass through is finished.
                    // if(part.render.text.index !== part.render.text.arrLength-1 && !part.render.text.isLoopDone) {

                    //     // console.log(part.position.x);
                    //     part.position.x = part.position.x + c.measureText(content).width;
                    // }
                    // else {
                    //     console.log("DONE");
                    //     part.render.text.isLoopDone = true;
